# UE4 Style guide based on [Gamemakin](https://gamemak.in)

*A mostly reasonable approach to Unreal Engine 4*

Heavily inspired by the [Airbnb Javascript Style Guide](https://github.com/airbnb/javascript) and 
[Unreal UI Best Practices](https://benui.ca/unreal/ui-best-practices/).
...
| Texture (Mask)          | T_         | _M         |                                  |
| Texture (Material ID Mask) | T_      | _I         |                                  |
